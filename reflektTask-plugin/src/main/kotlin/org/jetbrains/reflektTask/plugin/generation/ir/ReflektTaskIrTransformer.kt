...
/**
 * Sum of sizes of all the class properties
 */
@ObsoleteDescriptorBasedAPI
...
/**
 * Gets size of type in class after compilation to java bytecode in bytes
 * (e.g. Int? will compile to a reference which is 4 bytes)
 */
